...
cmds = []
for seed in seeds:
    cmd = "python train_ppo_clean_rl2.py --meta_learning False --suffle_mb False --env_name HalfCheetahDirEnv --device 'cuda:0' --config_path ./configs/cheetah_dir_config.yaml --seed {}".format(seed)
    cmds.append(cmd)
